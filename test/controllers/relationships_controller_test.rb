...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post relationships_url, params: { relationship: { sentence: @relationship.sentence, sentence_id: @relationship.sentence_id } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { sentence: @relationship.sentence, sentence_id: @relationship.sentence_id } }
