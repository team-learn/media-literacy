...
class DefinitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create definition" do
    assert_difference('Definition.count') do
      post definitions_url, params: { definition: { sentence: @definition.sentence, sentence_id: @definition.sentence_id } }
    end
  ...
  test "should update definition" do
    patch definition_url(@definition), params: { definition: { sentence: @definition.sentence, sentence_id: @definition.sentence_id } }
