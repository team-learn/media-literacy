...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post sentences_url, params: { sentence: { sentence: @sentence.sentence, type: @sentence.type } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { sentence: @sentence.sentence, type: @sentence.type } }
